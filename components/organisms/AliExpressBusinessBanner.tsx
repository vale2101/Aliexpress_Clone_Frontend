          ...
          <div className="grid lg:grid-cols-2 gap-6 items-center mb-6">
            ...
            <div>
              ...
              <div className="space-y-2">
                <div className="flex items-center gap-2 text-white text-sm">
                  <BadgeCheck size={18} /> Exenciones fiscales
                </div>
                <div className="flex items-center gap-2 text-white text-sm">
                  <Zap size={18} /> Pagos Express
                </div>
                <div className="flex items-center gap-2 text-white text-sm">
                  <DollarSign size={18} /> Apoyo financiero
                </div>
              </div>
              <button className="bg-white text-black px-4 py-1.5 rounded text-sm shadow hover:bg-gray-100 mt-4">
                Comprar
              </button>
            </div>
            ...
            <div className="grid grid-cols-2 gap-4 text-white text-center">
              <div>
                ...
                <div className="text-xs">Suministro directo</div>
              </div>
              <div>
                <div className="text-2xl font-bold">10</div>
                <div className="text-xs">Almacenes locales</div>
              </div>
              <div>
                <div className="text-2xl font-bold">20M+</div>
                <div className="text-xs">Artículos dropshipping</div>
              </div>
              <div>
                <div className="text-2xl font-bold">24H</div>
                <div className="text-xs">Abastecimiento rápido</div>
              </div>
            </div>
          </div>
